            ...
            createGrd1: function () {
                ...
                var columns_remind = [
                    ...
                    {name: "resource", dataType: "group", orientation: "horizontal", headerText: "리소스", headerVisible: true,  hideChildHeaders: false,
                        childs: [
                           {name: "resourceCode", dataType: "text", visible: true, editable: false, width: "10", headerText: "코드", headerVisible: true, textAlignment: "center" },
                           {name: "resourceName", dataType: "text", visible: true, editable: true, width: "10", headerText: "명", headerVisible: true, textAlignment: "certer" }
                        ]},
                    {name: "capantrgtyn", dataType: "boolean", visible: true, editable: true, width: "100",headerText: "Capa.\n비대상"},
                    {name: "baseManpower", dataType: "number", visible: true, editable: true, width: "100",headerText: "인원",format : "#,###"},
                    {name: "baseWork", dataType: "number", visible: true, editable: true, width: "100",headerText: "가동시간\n(MH)",format : "#,###.#"},
                    {name: "baseOperRat", dataType: "number", visible: true, editable: true, width: "130",headerText: "유효가동율\n(MH)",format : "#,###.#"},
                    {name: "baseEfcyRat", dataType: "number", visible: true, editable: true, width: "100",headerText: "효율\n(%)",format : "#,###.#"},
                    {name: "baseExtrawkRat", dataType: "number", visible: true, editable: true, width: "100",headerText: "잔업율\n(%)",format : "#,###.#"},
                    {name: "baseCapa", dataType: "number", visible: true, editable: false, width: "100",headerText: "Capacity",format : "#,###"},
                    {name: "capaUom", dataType: "text", visible: true, editable: true, width: "100",headerText: "단위", useDropdown: true, values: ["EA","MH","MM"], labels: ["EA","MH","MM"]},
                    {name: "resourceType1", dataType: "text", visible: true, editable: true, width: "100",headerText: "타입", useDropdown: true, values: [1,2,3], labels: ["자작","도급","외주"]},
                    {name: "sortSeq", dataType: "number", visible: true, editable: true, width: "100",headerText: "조회\n순서"},
                    {name: "useYn", dataType: "boolean", visible: true, editable: true, width: "100",headerText: "사용\n여부"}
                ];
                ...
                fields[site1SumIdx].calculateCallback = function (dataRow, fieldName, fieldNames, values) {
                    ...
                    if (capantrgtyn === false){
                        ...
                        gridView.setValue(dataRow,"baseCapa",baseCapa);
                    }
                    else
                        gridView.setValue(dataRow,"baseCapa",baseCapa = Math.round(baseManpower * (baseWork +(baseWork * (baseExtrawkRat /100))) *(baseOperRat / 100) * (baseEfcyRat / 100) ));
                };
